...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.TextBox2DXMin = QtWidgets.QLineEdit(self.centralwidget)
        ...
        self.TextBox2DXMax = QtWidgets.QLineEdit(self.centralwidget)
        ...
        self.TextBox2DYMin = QtWidgets.QLineEdit(self.centralwidget)
        ...
        self.TextBox2DYMax = QtWidgets.QLineEdit(self.centralwidget)
